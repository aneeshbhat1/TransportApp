...
//        }
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(this,email, password,new DALWrapper(this,this));
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        private final DALWrapper dalWrapper;
        private final Activity activity;
        boolean isValidUser ;
        UserLoginTask(Activity activity, String email, String password, DALWrapper dalWrapper) {
            mEmail = email;
            mPassword = password;
            this.dalWrapper = dalWrapper;
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                URL url = new URL(SERVER_ADDRESS + "GetUserDetails?userName="+mEmail+"&pwd="+mPassword);
